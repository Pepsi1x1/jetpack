...
class Grunion_Contact_Form_Field extends Crunion_Contact_Form_Shortcode {
	...
	function render() {
		...
		case 'date' :
			...
			$r .= "\t\t<input type='date' name='" . esc_attr( $field_id ) . "' id='" . esc_attr( $field_id ) . "' value='" . esc_attr( $field_value ) . "' " . $field_class . $field_placeholder . " " .  ( $field_required ? "required aria-required='true'" : "" ) . "/>\n";
			$r .= "\t</div>\n";
